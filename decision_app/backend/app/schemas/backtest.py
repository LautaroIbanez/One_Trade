...
class BacktestCreate(BaseModel):
    ...
    start_date: Optional[datetime] = Field(None, description="Start date (defaults to 365 days ago)")
    end_date: Optional[datetime] = Field(None, description="End date (defaults to today)")
